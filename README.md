...
```
npm create cloudflare@latest -- --template=cloudflare/templates/dry-silence-59e8
```

A live public deployment of this template is available at [https://dry-silence-59e8.templates.workers.dev](https://dry-silence-59e8.templates.workers.dev)
